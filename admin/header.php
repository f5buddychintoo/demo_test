...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="<?php echo BASE_URL;?>assest/bower_components/morrisjs/morris.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboard.php">welcome - <?php print($userRow['user_email']); ?></a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="logout.php?logout=true
